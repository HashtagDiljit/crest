...
const CONSENT_ITEMS: ConsentItem[] = [
  ...
  },
  {
    ...
    detail: "If enabled, we collect anonymous, aggregated data (e.g. 'X% of users log sleep daily') to understand how Crest is used. No individual tracking, no identifiers.",
    required: false,
  },
];
      ...
      <div className="w-full max-w-lg rounded-r5 border border-border bg-bg-surface shadow-2xl flex flex-col max-h-[90vh] overflow-hidden">
        ...
        <div className="px-6 pt-6 pb-4 border-b border-border flex-shrink-0">
          ...
          <p className="text-13 text-text-secondary leading-relaxed">
            Crest stores health and fitness data about you. UK law requires your explicit consent for each type. Please choose what you&apos;re comfortable with.
          </p>
        </div>
