  ...
  return (
    <div className="flex flex-col gap-6 max-w-2xl">
      ...
      <Section id="appearance" title="Appearance">
        <AppearanceSection theme={prefs?.theme ?? null} accentColour={prefs?.accent_colour ?? null} hiddenNavItems={prefs?.hidden_nav_items ?? null} reduceMotion={prefs?.reduce_motion ?? false} />
      </Section>
