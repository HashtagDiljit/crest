...
export const metadata = { title: "Terms of Service — Arc" };
    ...
    <div className="min-h-screen bg-bg-base">
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="flex flex-col gap-10 text-15 text-text-secondary leading-relaxed">
          ...
          <section>
            <h2 className="font-display text-20 font-semibold text-text-primary mb-4">Who can use Arc</h2>
            <p>Arc is available to users aged <strong className="text-text-primary">13 and over</strong>. This aligns with the UK GDPR child threshold. If you are under 13, please do not create an account. By using Arc, you confirm you meet this age requirement.</p>
          </section>

          <section>
            <h2 className="font-display text-20 font-semibold text-text-primary mb-4">What Arc is — and isn&apos;t</h2>
            <p className="mb-3">Arc is a <strong className="text-text-primary">personal tracking tool</strong>. It helps you log and visualise health, fitness, mood, and habit data.</p>
            <div className="rounded-r4 border border-warning bg-[rgba(245,158,11,0.06)] px-5 py-4">
              <p className="font-semibold text-text-primary mb-1">Arc is not a medical device or medical advice.</p>
              <p className="text-13 text-text-muted">Nothing in Arc should be used to diagnose, treat, or manage any medical condition. All metrics (body fat estimates, readiness scores, HRV trends) are personal tracking aids, not clinical measurements. Always consult a qualified healthcare professional for medical decisions.</p>
            </div>
          </section>
          ...
          <section>
            ...
            <ul className="flex flex-col gap-2 list-disc list-inside marker:text-text-muted">
              ...
              <li>You agree not to misuse Arc or attempt to access other users&apos; data</li>
          ...
          <section>
            ...
            <p>All data you log in Arc belongs to you. You can export it or delete it at any time from Settings → Data &amp; Privacy. See our <Link href="/privacy" className="text-accent hover:text-accent-hover transition-colors">Privacy Policy</Link> for full details on how we handle your data.</p>
          </section>
          ...
          <section>
            ...
            <p>Arc is provided as-is. We aim for high availability but cannot guarantee uninterrupted service. We may update or change features with reasonable notice.</p>
          </section>

          <section>
            <h2 className="font-display text-20 font-semibold text-text-primary mb-4">Limitation of liability</h2>
            <p>To the fullest extent permitted by law, Arc and its creators are not liable for any indirect, incidental, or consequential damages arising from your use of the app. Our total liability for any claim is limited to the amount you paid to use Arc in the 12 months preceding the claim (which is £0 for free accounts).</p>
          </section>

          <section>
            <h2 className="font-display text-20 font-semibold text-text-primary mb-4">Changes to these terms</h2>
            <p>We may update these terms from time to time. We will notify you of material changes via email or in-app notice. Continued use of Arc after changes constitutes acceptance.</p>
          </section>
